        ...
        <div className="flex gap-6 overflow-x-auto md:flex-wrap md:justify-center scrollbar-hide">
          ...
          {displayCategories?.map((category: any, index: any) => {
            ...
            return (
              ...
              >
                <div className="relative w-20 h-20 md:w-32 md:h-32 rounded-full overflow-hidden bg-gray-100 border border-gray-200 shadow-sm transition duration-300 hover:shadow-lg py-5">
                  <img
                    src={imageSrc}
