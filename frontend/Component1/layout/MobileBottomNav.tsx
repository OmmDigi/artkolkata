  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 px-2  shadow-[0_-2px_10px_rgba(0,0,0,0.05)]">
      <div className="flex justify-between items-center h-14 relative">
        ...
        <Link
          href="/account"
          className="flex flex-col items-center justify-center w-1/5 text-gray-900 hover:text-black transition-colors"
        >
        ...
        <div className="w-1/5 flex justify-center h-full relative">
          ...
          <span className="text-[10px] font-medium text-gray-900 absolute bottom-0">
            Products
          </span>
        </div>
        ...
        <Link
          href="/wishlist"
          className="relative flex flex-col items-center justify-center w-1/5 text-gray-900 hover:text-black transition-colors"
        >
