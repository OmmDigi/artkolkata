export default function PrivacyPolicy() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-5 min-h-[70vh] bg-white">
      <h1 className="text-4xl font-bold mb-8 text-gray-700">Privacy Policy – ART KOLKATA</h1>
      
      <div className="space-y-6 text-gray-700 leading-relaxed">
        <p className="font-semibold">Effective Date: July 27, 2026</p>
        
        <p>
          Welcome to ART KOLKATA. Your privacy is important to us. This Privacy Policy explains how we collect, use, disclose, and protect your personal information when you use our website and services.
        </p>

        <section>
          <h2 className="text-2xl font-semibold mb-3">1. Business Information</h2>
          <p>Business Name: ART KOLKATA</p>
          <p>Address: Duttapukur, North 24 Parganas, West Bengal – 743248, India</p>
          <p>Email: Surajsarkar1349@gmail.com</p>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3">4. Payment Security</h2>
          <p>
            We do not store your complete payment card details. Payments are processed securely by trusted third-party payment gateways.
          </p>
        </section>

        <section>
          <h2 className="text-2xl font-semibold mb-3">5. Sharing of Information</h2>
          <p className="mb-2">We do not sell or rent your personal information. We may share information only with:</p>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          ...
          <p>
            We may update this Privacy Policy at any time. Changes will become effective once published on our website.
          </p>
        </section>

        <section className="mt-8 pt-8 border-t border-gray-200">
          <h2 className="text-2xl font-semibold mb-3">11. Contact Us</h2>
          <p className="mb-2">For any privacy-related questions, please contact:</p>
