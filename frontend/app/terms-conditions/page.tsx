  ...
  return (
    <main className="max-w-4xl mx-auto py-16 px-5 min-h-[70vh] bg-white">
      <h1 className="text-4xl font-bold mb-8 text-gray-700">
        Terms & Conditions – ART KOLKATA
      </h1>

      <div className="space-y-6 text-gray-700 leading-relaxed">
        <p>
          Welcome to ART KOLKATA. By accessing or using our website, you agree
        ...
        <section>
          ...
          <p>
            ART KOLKATA offers products through its online platform. Product
            descriptions, images, and pricing are provided as accurately as
            possible but may occasionally contain errors.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-6 space-y-1">
            ...
            <li>
              Customers must provide accurate information while placing an
              order.
            </li>
          </ul>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold mb-3">4. Pricing</h2>
          <p>
            Prices are subject to change without prior notice. Applicable taxes
            and shipping charges will be added where required.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            the website. Orders will be processed only after successful payment
            confirmation.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            operations or unforeseen circumstances.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Returns and refunds will be governed by the Return and Refund Policy
        ...
        <section>
          ...
          <p>
            All content, including text, images, logos, graphics, and designs on
            this website, is the property of ART KOLKATA and may not be copied
        ...
        <section>
          ...
          <p>
            ART KOLKATA shall not be liable for any indirect, incidental, or
